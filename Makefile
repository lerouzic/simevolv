...
$(OBJDIR_DEBUG)/ArchiRegulatory.o: ArchiRegulatory.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c ArchiRegulatory.cpp -o $(OBJDIR_DEBUG)/ArchiRegulatory.o
...
$(OBJDIR_RELEASE)/ArchiRegulatory.o: ArchiRegulatory.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c ArchiRegulatory.cpp -o $(OBJDIR_RELEASE)/ArchiRegulatory.o
